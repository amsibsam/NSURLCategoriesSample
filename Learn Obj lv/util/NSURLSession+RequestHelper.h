...
- (void)request:(NSString*) url withMethod:(NSString*)httpMethod andParams:(NSDictionary*) params timeout:(NSTimeInterval*) timeout completionHandler:(void (^)(NSData *data, NSURLResponse *response, NSError *error)) completion;
